...
importers:
  ...
  .:
    devDependencies:
      ...
      tsup:
        specifier: ^8.5.1
        version: 8.5.1(tsx@4.23.1)(typescript@6.0.3)(yaml@2.9.0)
      typescript-eslint:
        specifier: ^8.64.0
        version: 8.64.0(eslint@10.7.0)(typescript@6.0.3)

  nexus-core-backend/packages/common:
    dependencies:
      dotenv:
        specifier: ^17.4.2
        version: 17.4.2
  ...
  nexus-core-backend/services/gateway-service: {}
...
snapshots:
  ...
  postcss-load-config@6.0.1(tsx@4.23.1)(yaml@2.9.0):
    dependencies:
      lilconfig: 3.1.3
    optionalDependencies:
      tsx: 4.23.1
  ...
  tsup@8.5.1(tsx@4.23.1)(typescript@6.0.3)(yaml@2.9.0):
    dependencies:
      bundle-require: 5.1.0(esbuild@0.27.7)
      cac: 6.7.14
      chokidar: 4.0.3
